...
import org.ccnx.ccn.io.content.*;
import org.ccnx.ccn.io.ErrorStateException;
import org.ccnx.ccn.protocol.ContentName; import org.ccnx.ccn.protocol.ContentObject;
 ...
 */
public class CCNByteObject extends CCNNetworkObject<byte[]> {
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentName name, byte[] data, SaveType saveType, CCNHandle handle) 
				throws IOException {
		super(byte[].class, false, name, data, saveType, handle);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentName name, byte[] data, SaveType saveType, PublisherPublicKeyDigest publisher, 
							KeyLocator locator, CCNHandle handle) throws IOException {
		super(byte[].class, false, name, data, saveType, publisher, locator, handle);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentName name, CCNHandle handle) 
				throws ContentDecodingException, IOException {
		super(byte[].class, false, name, (PublisherPublicKeyDigest)null, handle);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentName name, PublisherPublicKeyDigest publisher,
							CCNHandle handle) 
				throws ContentDecodingException, IOException {
		super(byte[].class, false, name, publisher, handle);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentObject firstBlock, CCNHandle handle) 
				throws ContentDecodingException, IOException {
		super(byte[].class, false, firstBlock, handle);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentName name, byte[] data, 
			PublisherPublicKeyDigest publisher, 
			KeyLocator locator,
			CCNFlowControl flowControl) throws IOException {
		super(byte[].class, false, name, data, publisher, locator, flowControl);
	}
	...
	public CCNByteObject(ContentName name, PublisherPublicKeyDigest publisher,
		...
		super(byte[].class, false, name, publisher, flowControl);
	}
	 ...
	 * @throws IOException
	 */
	public CCNByteObject(ContentObject firstSegment, CCNFlowControl flowControl) 
					throws ContentDecodingException, IOException {
		super(byte[].class, false, firstSegment, flowControl);
	}

	@Override
	protected byte[] readObjectImpl(InputStream input) throws ContentDecodingException, IOException {
	...
	public String string() throws ContentNotReadyException, ContentGoneException, ErrorStateException { return new String(data()); }
	public byte[] byteArray() throws ContentNotReadyException, ContentGoneException, ErrorStateException { return data(); }
}
